function marinaraSauce(cookName) {
    ...
    console.log('- Add '+ oneFourth +' cup of water, '+ two +'  cans of crushed tomatoes, and salt and season with black pepper to taste');
    ...
    console.log('- Stir in '+ oneFourth +' roughly chopped fresh basil, salt and pepper as needed.');
}
marinaraSauce("Merry Mac");
